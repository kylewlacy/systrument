...
fn test_strace_parse_line_basic() {
    ...
    assert_eq!(syscall.args_string.value, "NULL");
    assert_eq!(syscall.result_string.value, "0x555589aac000");
    ...
    assert_eq!(syscall.args_string.value, "");
    assert_eq!(
        syscall.result_string.value,
...
fn test_strace_parse_line_examples() {
    ...
    assert_eq!(syscall.result_string.value, "2386283");
    ...
    assert_eq!(syscall.result_string.value, "100");
    ...
    assert_eq!(syscall.result_string.value, "965");
    ...
    assert_eq!(syscall.result_string.value, "20");
